...
<template>
  <section
    class="text-white py-20 lg:py-28"
    :style="gradientStyle"
  >
    <div class="max-w-6xl mx-auto px-6">
      <div class="max-w-4xl">
        ...
        <h1 class="text-4xl lg:text-5xl font-bold leading-tight mb-6">
          Controle financeiro para gestores de aluguel por temporada
        </h1>
        ...
        <div class="flex flex-wrap gap-2 mb-8">
          <span
            v-for="tag in ['Fluxo de Caixa', 'Contas a Pagar/Receber', 'Notas Fiscais', 'Prestação de Contas', 'Repasses', 'Portal do Proprietário', 'Check-in/out', 'Limpeza', 'Manutenções', 'Relatórios']"
            :key="tag"
